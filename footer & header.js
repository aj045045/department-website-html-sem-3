...
let appHeader = `<h4><div class="fx1">
...
<nav class="navbar navbar-expand-sm navbar-dark  " id="back-color">
        <div class="container flex-start">
            <a class="navbar-brand" href="home.html"> <img src="image/logo1.webp" alt="Avatar Logo" style="width:60px;" class="rounded-pill"> </a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                    ...
                    <li>
                    <a class="nav-link text-light" href="signin.html"><b>SIGN IN</b></a><br>
                    </li>
                </ul>

                
                <form action="/action_page.php" style="padding-top: 15px;">
